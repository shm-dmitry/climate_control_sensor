...
void app_main(void)
{
	...
	sgp30_init(CONFIG_SGP30_PORT, CONFIG_SGP30_TOPIC_STATUS, CONFIG_SGP30_TOPIC_COMMAND);
#endif
	...
	fan_startup(CONFIG_FAN_GPIO, CONFIG_FAN_MQTT_TOPIC_COMMAND, CONFIG_FAN_MQTT_TOPIC_STATUS);
#endif
